defmodule StreetfoodWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(StreetfoodWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(StreetfoodWeb.Gettext, "errors", msg, opts)
    end
  end
